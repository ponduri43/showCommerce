...
/**
 * Created by BMP on 22-01-2016.
 */
public class ActionBarSuggestionAdapter extends CursorAdapter {
    ...
    public ActionBarSuggestionAdapter(Context context, Cursor cursor, ArrayList<ActionbarProductObject> items)
    {
